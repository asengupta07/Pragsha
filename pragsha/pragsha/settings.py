"""
Django settings for pragsha project.
...
SECRET_KEY = "django-insecure-ru+qzqgu$$cre@&xt$=^t6l))74dfoa-82n6se_!ru=9&n%a6n"
...
WSGI_APPLICATION = "pragsha.wsgi.application"
